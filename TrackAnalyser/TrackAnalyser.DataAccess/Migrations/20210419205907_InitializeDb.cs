        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CanalId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackEmissions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackEmissions_CanalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackStatistics_CanalId",
